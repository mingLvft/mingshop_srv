...
func (s *GoodsServer) GetSubCategory(ctx context.Context, req *proto.CategoryListRequest) (*proto.SubCategoryListResponse, error) {
	...
	var subCategoryResponses []*proto.CategoryInfoResponse
	...
	for _, subCategory := range subCategorys {
		subCategoryResponses = append(subCategoryResponses, &proto.CategoryInfoResponse{
			Id:             subCategory.ID,
	...
	categoryListResponse.SubCategorys = subCategoryResponses
